...
class CapacityAgent(AgentBase):
    ...
    async def analyze(self, incident_data: Dict) -> Dict:
        ...
        available_icu_beds = incident_data.get("available_icu_beds", max(0, total_icu_beds - int(total_icu_beds * icu_pct / 100)))
        ...
        projected_icu_pct = min(100, icu_pct + (incoming * 0.4))  # 40% of trauma → ICU
        ...
        # Step 4: Identify surge capacity options
        ...
        if icu_pct > 85:
            # Can transfer stable ICU patients to step-down
